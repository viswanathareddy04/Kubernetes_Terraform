...
#But there's a Pod still on c1-node...wut? 
...
#starts at 10 seconds and defaults to Always. We covered this in detail in my course "Managing the kuberentes api and Pod"
...
#And go start c1-node3 back up again :)
